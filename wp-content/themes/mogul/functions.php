...
function mogul_scripts() {
	wp_enqueue_style( 'bootstrap-style', get_template_directory_uri() . '/libs/bootstrap-4.1.0/css/bootstrap.min.css');
	wp_enqueue_style( 'mogul-style', get_stylesheet_uri() );

	wp_deregister_script('jquery');
	wp_enqueue_script('jquery', get_template_directory_uri() . '/libs/jquery/jquery-3.3.1.min.js', array(), '3.3.1', false);
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/libs/bootstrap-4.1.0/js/bootstrap.min.js', array(), '4.1.0', true );
	wp_enqueue_script( 'mogul-js', get_template_directory_uri() . '/js/common.js', array('jquery'), null, true );
}
